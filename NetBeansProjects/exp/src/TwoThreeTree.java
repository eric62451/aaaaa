...
public class TwoThreeTree
{
    ...
    private void split(Node k)
    {
        ...
        if((k.parent.children[0]!=null && k.parent.children[1]==null)||k.parent.children[0]==null)//1 child, if akey less than the first key,add and swap, then do the bkey, else just add it to the children array
        {
            k.parent.children[0] = a;
            k.parent.children[1] = b;
        }
        else if(k.parent.children[0]!=null && k.parent.children[1]!=null&& k.parent.children[2]== null)
        {
            if(k.equals(k.parent.children[0]))
            {
                Node temp = k.parent.children[1];
                k.parent.children[0] = a;
                k.parent.children[1] = b;
                k.parent.children[2] = temp;
            }
            else
            {
        ...
        else//bkey & akey are not more than or less than children 0 and 1, add it one by one else just add and swap
        {
            if(k.equals(k.parent.children[0]))
            {
                Node tempa = k.parent.children[1];
                Node tempb= k.parent.children[2];
                k.parent.children[0] = a;
                k.parent.children[1] = b;
                k.parent.children[2] = tempa;
                k.parent.children[3] = tempb;
            }
            ...
            {
                Node temp2 = k.parent.children[1];
                k.parent.children[1] = a;
                k.parent.children[2] = b;
